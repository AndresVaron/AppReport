...
class Competidores extends StatefulWidget {
  const Competidores({Key key}) : super(key: key);
  @override
  CompetidoresState createState() => CompetidoresState();
}

class CompetidoresState extends State<Competidores> {
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  InfoTema contador;
  int con;
  final String id = "competidores";
  final int index = 3;
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
              Padding(
                ...
                child: Container(
                  ...
                  child: Center(
                      child: Text(
                          'Competidores del Antes y Del Ahora en Cross-Platform',
